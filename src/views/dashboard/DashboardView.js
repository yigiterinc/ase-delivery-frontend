...
export const DashboardView = () => {
  ...
  const userArray = {columns:[{dataField: 'ID', text:'ID'}, {dataField: 'Name', text:'Name'}, {dataField: 'Email', text:'Email'}, {dataField: 'Type', text:'Type'}, {dataField: 'Password', text:'Password'}, {dataField: 'RFID', text:'RFID'}],
  ...
  const deliveryArray = {columns:[{dataField: 'ID', text:'ID'}, {dataField: 'BoxID', text:'BoxID'}, {dataField: 'CustomerID', text:'CustomerID'}, {dataField: 'DelivererID', text:'DelivererID'}, {dataField: 'TrackingCode', text:'TrackingCode'}, {dataField: 'DeliveryStatus', text:'DeliveryStatus'}],
  ...
  const boxArray = {columns:[{dataField: 'ID', text:'ID'}, {dataField: 'Name', text:'Name'}, {dataField: 'Address', text:'Address'}],
    ...
    <Container fluid>
      <Row >
        ...
        <Col className="colHeight" >
          { showUser ? <ElementListing title="Users" table={userArray}/> : null }
          { showDelivery ? <ElementListing title="Deliveries" table={deliveryArray}/> : null }
          { showBox ? <ElementListing title="Boxes" table={boxArray} /> : null }
        </Col>
      </Row>
    </Container>
  );
